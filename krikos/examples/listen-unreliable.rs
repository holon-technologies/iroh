//! The smallest example showing how to use krikos and [`krikos::Endpoint`] to connect two devices and pass bytes using unreliable datagrams.
//!
...
use krikos::{Endpoint, RelayMode, SecretKey, endpoint::presets};
