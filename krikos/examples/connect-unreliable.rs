//! The smallest example showing how to use krikos and [`krikos::Endpoint`] to connect to a remote endpoint and pass bytes using unreliable datagrams.
//!
...
//!
//! Run the `listen-unreliable` example first (`krikos/examples/listen-unreliable.rs`), which will give you instructions on how to run this example to watch two endpoints connect and exchange bytes.
use std::net::SocketAddr;

use clap::Parser;
use krikos::{Endpoint, EndpointAddr, RelayMode, RelayUrl, SecretKey, endpoint::presets};
use krikos_base::TransportAddr;
