//! Utils for emitting qlog files from krikos endpoint.
...
impl QlogFileGroup {
    ...
    /// if the "qlog" feature is enabled and the environment variable KRIKOS_TEST_QLOG is set to 1.
    ...
    ///
    /// If the "qlog" feature is enabled, and the environment variable KRIKOS_TEST_QLOG is set,
    ...
    pub fn create(&self, name: impl ToString) -> Result<QuicTransportConfig> {
        ...
        #[cfg(feature = "qlog")]
        {
            ...
            if std::env::var("KRIKOS_TEST_QLOG").is_ok() {
