...
use krikos_base::{CustomAddr, EndpointAddr, EndpointId, RelayUrl, TransportAddr};
#[cfg(not(wasm_browser))]
use krikos_runtime::Instant;
...
impl RemoteStateActor {
    ...
    pub(super) fn start(
        ...
        #[cfg(not(wasm_browser))]
        {
            ...
            runtime
                .spawn(
                    krikos_runtime::TaskKind::Other("remote-state-actor".to_owned()),
                    "remote-state-actor",
                    Box::pin(future),
                )
