...
use krikos_base::{EndpointAddr, EndpointId, TransportAddr};
...
fn noq_seed_is_replayable_and_endpoint_scoped() {
    let context = krikos_runtime::RuntimeContext::tokio(
        krikos_runtime::RootSeed::new([31; 32]),
...
fn default_options(rng: &mut impl CryptoRng) -> Options {
    ...
    let runtime_context = Arc::new(krikos_runtime::RuntimeContext::production(Arc::new(
