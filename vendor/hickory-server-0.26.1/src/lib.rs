...
// The crates.io package omits Hickory's workspace-only test-support crate. Keep the packaged unit
// tests runnable without changing production code.
#[cfg(test)]
extern crate self as test_support;

/// Initializes tracing in vendored unit tests.
#[cfg(test)]
pub fn subscribe() {}
