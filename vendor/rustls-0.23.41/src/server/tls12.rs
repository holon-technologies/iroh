...
mod client_hello {
    ...
    impl CompleteClientHelloHandling {
        pub(in crate::server) fn handle_client_hello(
            ...
            if !self.config.session_storage.can_cache() {
                ...
                self.session_id = SessionId::random(self.config.provider.secure_random.as_ref())?;
            }

            cx.common.kx_state = KxState::Start(selected_kxg.clone());
    ...
    fn emit_server_kx(
        ...
        selected_group: &dyn SupportedKxGroup,
