...
mod client_hello {
    ...
    impl CompleteClientHelloHandling {
        ...
        pub(in crate::server) fn handle_client_hello(
            ...
            selected_kxg: Arc<dyn SupportedKxGroup>,
            ...
            let chosen_share_and_kxg = shares_ext.iter().find_map(|share| {
                (share.group == selected_kxg.name()).then_some((share, selected_kxg.clone()))
            });
    ...
    fn emit_server_hello(
        ...
        share_and_kxgroup: (&KeyShareEntry, Arc<dyn SupportedKxGroup>),
...
impl ExpectFinished {
    fn emit_ticket(
        ...
        let secure_random = config.provider.secure_random.as_ref();
