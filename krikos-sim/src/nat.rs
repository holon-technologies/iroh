...
use krikos_runtime::{DecisionStream, RuntimeContext, TraceContext, TraceEventKind};
...
pub enum NatError {
    ...
    TimelineOverflow,
    Decision(krikos_runtime::DecisionError),
    Ledger(LedgerError),
    Clock(krikos_runtime::ClockError),
    Trace(krikos_runtime::TraceRecordError),
}
...
impl From<krikos_runtime::DecisionError> for NatError {
    fn from(value: krikos_runtime::DecisionError) -> Self {
        Self::Decision(value)
    }
}
...
impl From<krikos_runtime::ClockError> for NatError {
    fn from(value: krikos_runtime::ClockError) -> Self {
        Self::Clock(value)
    }
}
impl From<krikos_runtime::TraceRecordError> for NatError {
    fn from(value: krikos_runtime::TraceRecordError) -> Self {
        Self::Trace(value)
    }
}
