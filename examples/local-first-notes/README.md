...
This executable demonstrates the standard unpublished `iroh-app` bundle using only public
...
```console
cargo run -p local-first-notes -- /tmp/iroh-notes-demo "my first note"
```
