...
use krikos::{Endpoint, EndpointAddr, PublicKey};
use krikos_blobs::{
    Hash,
...
pub struct Engine {
    ...
    blob_store: krikos_blobs::api::Store,
...
impl Engine {
    ...
    pub async fn spawn(
        ...
        bao_store: krikos_blobs::api::Store,
        ...
        let content_status_cb: ContentStatusCallback = {
            ...
            Arc::new(move |hash: krikos_blobs::Hash| {
...
impl ProtectCallbackHandler {
    ...
    ///
    /// The returned [`ProtectCb`] must be passed set in the [`GcConfig`] of the [`krikos_blobs`] store where
    ...
    /// [`GcConfig`]: krikos_blobs::store::GcConfig
