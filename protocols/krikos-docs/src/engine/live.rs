...
use krikos::{Endpoint, EndpointAddr, EndpointId, PublicKey, address_lookup::memory::MemoryLookup};
use krikos_blobs::{
    Hash, HashAndFormat,
    api::{
        Store,
...
impl LiveActor {
    ...
    pub async fn handle_connection(&mut self, conn: krikos::endpoint::Connection) {
