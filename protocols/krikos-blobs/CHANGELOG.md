...
All notable changes to krikos-blobs will be documented in this file.
...
- [**breaking**] Update to krikos 1.0 ([#239](https://github.com/n0-computer/iroh-blobs/issues/239)) - ([5a3cfad](https://github.com/n0-computer/iroh-blobs/commit/5a3cfadcde17cecb79e5db1b9d7c398c08c3ae16))

## [0.102.0](https://github.com/n0-computer/iroh-blobs/compare/v0.101.0..0.102.0) - 2026-05-27

### ⛰️  Features

- [**breaking**] Update to krikos@1.0.0-rc.1 ([#234](https://github.com/n0-computer/iroh-blobs/issues/234)) - ([8933aff](https://github.com/n0-computer/iroh-blobs/commit/8933aff25b6a12461ea2595f1eb913c653f100e5))
...
- Use connection pool from krikos-util ([#229](https://github.com/n0-computer/iroh-blobs/issues/229)) - ([d0ba8d8](https://github.com/n0-computer/iroh-blobs/commit/d0ba8d8f4efa05c80427e688f4b63bca2f6d73c1))
...
- Update to `krikos` v0.35 ([#91](https://github.com/n0-computer/iroh-blobs/issues/91)) - ([8a975ec](https://github.com/n0-computer/iroh-blobs/commit/8a975ecda8bca5e8988db911857012e6817b456e))
...
- Update bao-tree dependency and get rid of krikos-blake3 dep ([#81](https://github.com/n0-computer/iroh-blobs/issues/81)) - ([2e823f6](https://github.com/n0-computer/iroh-blobs/commit/2e823f697a251df8d59fcda7bb3b25aa755eff6c))
...
- Update to latest krikos ([#77](https://github.com/n0-computer/iroh-blobs/issues/77)) - ([253a8c6](https://github.com/n0-computer/iroh-blobs/commit/253a8c6bf05db30bf39485822f0e2114481e26ce))
...
- Patch to use main branch of krikos dependencies ([#64](https://github.com/n0-computer/iroh-blobs/issues/64)) - ([d739d52](https://github.com/n0-computer/iroh-blobs/commit/d739d5225029d40749150ad4f2d5e1c1c6f1c0c4))
...
- Release krikos-blobs version 0.33.1 - ([e4aa724](https://github.com/n0-computer/iroh-blobs/commit/e4aa7245a3ec31a652a5573b70928d0dffd7fbc7))
...
- Patch to use main branch of krikos dependencies ([#58](https://github.com/n0-computer/iroh-blobs/issues/58)) - ([57cb626](https://github.com/n0-computer/iroh-blobs/commit/57cb62696bbad313d497c4a33821657fb6bf53ee))
- Upgrade to latest `krikos` and `quic-rpc` ([#63](https://github.com/n0-computer/iroh-blobs/issues/63)) - ([a198ccc](https://github.com/n0-computer/iroh-blobs/commit/a198cccbde55071973e2b637e7e3ea56908f5d7d))
...
- Upgrade to `krikos@v0.32.0` and `quic-rpc@v0.18.1` ([#52](https://github.com/n0-computer/iroh-blobs/issues/52)) - ([7dccac9](https://github.com/n0-computer/iroh-blobs/commit/7dccac9610482f9acbde4c46a134d99e979e6001))
...
- Upgrade to `krikos@v0.31.0` ([#45](https://github.com/n0-computer/iroh-blobs/issues/45)) - ([2b800c9](https://github.com/n0-computer/iroh-blobs/commit/2b800c9264b21dfb73bfecbe9881bc6c07c7e0d1))
...
- Import krikos_base::ticket::BlobTicket and krikos_base::hash - ([f9d3ae1](https://github.com/n0-computer/iroh-blobs/commit/f9d3ae1e6a0cbdbdece56b0b3d948f0a3d62118c))
- [**breaking**] Update to krikos@0.30.0 ([#41](https://github.com/n0-computer/iroh-blobs/issues/41)) - ([74f1ee3](https://github.com/n0-computer/iroh-blobs/commit/74f1ee32cca396cd8e4d1cb8815b71e27c98df74))
...
- [**breaking**] Make Dialer trait private and inline krikos::dialer::Dialer ([#34](https://github.com/n0-computer/iroh-blobs/issues/34)) - ([d91b2ce](https://github.com/n0-computer/iroh-blobs/commit/d91b2ce7784cfa78fd2e6f9e0fb74f9b950a878f))
...
- Update to renamed krikos-net ([#18](https://github.com/n0-computer/iroh-blobs/issues/18)) - ([b9dbf2c](https://github.com/n0-computer/iroh-blobs/commit/b9dbf2cc1e6d8a6b60f3bf9f52b832fbd23c394e))
- Update to krikos@0.29.0  - ([e9b136a](https://github.com/n0-computer/iroh-blobs/commit/e9b136ad59d8feddd16df50503bf67206cccedd9))
...
- Use correctly patched krikos-quinn and krikos-net - ([b3c5f76](https://github.com/n0-computer/iroh-blobs/commit/b3c5f7624716896c085add70215336404188442a))

### ⚙️ Miscellaneous Tasks

- Release krikos-blobs version 0.28.1 - ([191cd2a](https://github.com/n0-computer/iroh-blobs/commit/191cd2a1c25885f8ef0d58d83df150017bc4c8bb))
