//! Protocol for transferring content-addressed blobs over [`krikos`] p2p QUIC connections.
//!
//! # Participants
//!
...
//!
//! ```rust
//! # use krikos_blobs::protocol::GetRequest;
//! # let hash: krikos_blobs::Hash = [0; 32].into();
...
//!
//! ```rust
//! # use krikos_blobs::protocol::{GetRequest, ChunkRanges, ChunkRangesExt};
//! # let hash: krikos_blobs::Hash = [0; 32].into();
...
//!
//! ```rust
//! # use krikos_blobs::protocol::{GetRequest, ChunkRanges, ChunkRangesExt, ChunkRangesSeq};
//! # let hash: krikos_blobs::Hash = [0; 32].into();
//! let request = GetRequest::builder()
...
//!
//! ```rust
//! # use krikos_blobs::protocol::{ChunkRanges, ChunkRangesExt, GetRequest};
//! # let hash: krikos_blobs::Hash = [0; 32].into();
//! let request = GetRequest::builder()
...
//!
//! ```rust
//! # use krikos_blobs::protocol::{GetRequest, ChunkRanges, ChunkRangesSeq};
//! # let child_hash: krikos_blobs::Hash = [0; 32].into();
...
//!
//! ```rust
//! # use krikos_blobs::protocol::{GetManyRequest, ChunkRanges, ChunkRangesExt};
//! # let hash1: krikos_blobs::Hash = [0; 32].into();
//! # let hash2: krikos_blobs::Hash = [1; 32].into();
...
pub enum Closed {
    ...
    ///
    /// [`RecvStream`]: krikos::endpoint::RecvStream
    /// [`RecvStream::stop`]: krikos::endpoint::RecvStream::stop
    StreamDropped = 0,
