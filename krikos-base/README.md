...
`krikos-base` provides the base types and utilities shared across the
Krikos crates: keys, addresses, and other foundations that
[`krikos`](../krikos) and the rest of the workspace build on.
