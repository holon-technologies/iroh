...
|--------------|-----------|----------------|------|--------|
| 0x00-0x1F    | -         | -              | -    | reserved |
| 0x20         | Test      | Ed25519 public key (32 bytes) | krikos (test-utils) | internal |
| 0x544F52     | Tor       | Ed25519 public key (32 bytes) | [krikos-tor](https://github.com/n0-computer/iroh-tor) | experimental |
