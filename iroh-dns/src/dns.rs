...
//!
//! Generic host, address, and TXT resolution lives in [`iroh_resolver`]. This module composes
//! that service with Iroh endpoint-record parsing.

use iroh_base::EndpointId;
use iroh_resolver::{DNS_TIMEOUT, DnsResolver, StaggeredError};
...
pub enum LookupError {
    ...
    LookupFailed { source: iroh_resolver::DnsError },
}
...
mod tests {
    ...
    use iroh_resolver::{BoxIter, DnsError, Resolver, TxtRecordData};
