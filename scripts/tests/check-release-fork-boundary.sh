...
require_text .github/workflows/ci.yml 'cargo test --manifest-path krikos-sim/Cargo.toml'
require_text .github/workflows/ci.yml 'cargo clippy --manifest-path krikos-sim/Cargo.toml'
require_text .github/workflows/ci.yml 'cargo doc --manifest-path krikos-sim/Cargo.toml'
